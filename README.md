...
You should also link your new **Gym** environment to Jupyter so that you can choose it as a Kernal.  Always make sure to run your Jupyter notebooks from your 3.9 kernel.

```
python -m ipykernel install --user --name tensorflow --display-name "Python 3.9 (Gym)"
```
```
